...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="dashboard.php" class="logo">WEB <span class="lite">Admin</span></a>
            <!--logo end-->
            ...
            <section class="wrapper"> 
                ...
                if(isset($_REQUEST["page"])) {
                    switch($_REQUEST["page"]) {
                        case "dashboard": include("content_dashboard.php");break;
                        case "berita": include("content_berita.php");break;
